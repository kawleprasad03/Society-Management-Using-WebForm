<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="BillManagementUser.aspx.cs" Inherits="SocietyManagement.BillManagementUser" %>
     ...
     <div class="card">
      <div class="card-body">
          ...
          <div class="table-responsive">
              ...
              <asp:GridView ID="GridView1" class="table table-hover" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" BorderStyle="None" BorderWidth="0px">
