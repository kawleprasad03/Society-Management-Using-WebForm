<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="EditBillAdmin.aspx.cs" Inherits="SocietyManagement.EditBillAdmin" %>
    ...
    <div class="container d-flex justify-content-center">
        <div class="card w-50">
            <div class="card-body">
                ...
                <asp:Button ID="Button1" runat="server" class="btn btn-primary mr-2" Text="Edit" OnClick="Button1_Click" />
