<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="VisitorManagementAdmin.aspx.cs" Inherits="SocietyManagement.VisitorManagementAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card">
        <div class="card-body">
            ...
            <asp:Button ID="btnAdd" CssClass="btn btn-success mb-3" Text="Add" OnClick="btnAdd_Click" runat="server" />

            <!-- Success message label -->
            <asp:Label ID="lblSuccessMessage" runat="server" CssClass="text-success"></asp:Label>
            <div class="table-responsive">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-hover" OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound">
                    <Columns>
